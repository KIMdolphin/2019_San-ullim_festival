...
<html >
  <head>
    ...
    <title>공성전 1팀 확인 페이지</title>
  </head>
  <body>
    <center>
    <video id="video" preload="auto" autoplay="true" loop="loop" muted="muted" volume="0">
      <source src="background/onefire.mp4">
    </video>
    <br><br>
    <img src="img/team1.png" alt="Team 1" width=10%, height=10% ><br>
    <infor>현재 점수 안내</infor><br>
    <?php
    require $_SERVER["DOCUMENT_ROOT"].'/scripts/dbconnect.php';
    $connect = DBConnect();

    $result = mysqli_query($connect, "select * from score where team='1'");
